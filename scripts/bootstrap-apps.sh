...
function apply_sops_secrets() {
    ...
    local -r secrets=(
        ...
        "${ROOT_DIR}/kubernetes/components/common/sops/sops-age-pq.sops.yaml"
        "${ROOT_DIR}/kubernetes/apps/external-secrets/onepassword/app/onepassword-secret.sops.yaml"
    )
